#!/usr/bin/env python
"""
This script facilitates using UKFast's eCloud Vault for cPanel/WHM backups.
"""
...
objStoreHost = 'vault.ecloud.co.uk'
accessKey = userName
...
logDir = 'log'
if not os.path.isdir(logDir): # I like to live dangerously, just checks for the existence of the log directory by checking if it *is* a directory. Theoretically, the log directory could be a file, so..
	os.mkdir(logDir)
